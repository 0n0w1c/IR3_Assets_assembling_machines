...
require("prototypes/explosion/assembling-machine-1-explosion")
...
require("prototypes/explosion/assembling-machine-2-explosion")
...
require("prototypes/explosion/assembling-machine-3-explosion")
...
if settings.startup["IR3-add-1x1"].value == true then
    require("prototypes/explosion/small-assembling-machine-1-explosion")
    ...
    require("prototypes/explosion/small-assembling-machine-2-explosion")
