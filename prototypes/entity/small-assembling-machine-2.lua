...
entity.name = "small-assembling-machine-2"
        ...
        layers = {
            {
                ...
                filename =
                "__IndustrialRevolution3Assets1__/graphics/entities/machines/assemblers/small-assembler-3-base.png",
                frame_count = 64,
                height = 128,
                line_length = 8,
                priority = "high",
...
entity.dying_explosion = "small-assembler-2-explosion"
entity.fast_replaceable_group = "small-assembling-machines"
entity.icon = "__IndustrialRevolution3Assets1__/graphics/icons/64/small-assembler-3.png"
entity.icon_size = 64
entity.ingredient_count = 1
entity.match_animation_speed_to_activity = false
entity.minable = { mining_time = 0.2, result = "small-assembling-machine-2" }
entity.module_slots = 1
entity.next_upgrade = nil
entity.placeable_by = { count = 1, item = "small-assembling-machine-2" }
